...
public class MapNodes {
  ...
  public static <K, V> INode<K, V> mergeNodes(
      int shift,
      Object editor,
      INode<K, V> a,
      INode<K, V> b,
  ...
  public static <K, V> Node<K, V> merge(
      int shift,
      Object editor,
      Node<K, V> a,
      Node<K, V> b,
  ...
  public static <K, V> INode<K, V> diffNodes(
      int shift,
      Object editor,
      INode<K, V> a,
      INode<K, V> b,
  ...
  public static <K, V> Node<K, V> difference(
      int shift,
      Object editor,
      Node<K, V> a,
      Node<K, V> b,
  ...
  public static <K, V> INode<K, V> intersectNodes(
      int shift,
      Object editor,
      INode<K, V> a,
      INode<K, V> b,
  ...
  public static <K, V> Node<K, V> intersection(
      int shift,
      Object editor,
      Node<K, V> a,
      Node<K, V> b,
